...
<svelte:window  on:dragover|preventDefault={handleDragOver} on:dragleave|preventDefault={handleDragLeave} on:drop={handleFileDrop} />
<section class="file-upload">
  <button class="file-upload-btn"  type="button" on:click={() =>fileInput.click() }>
  ...
  <div class="image-upload-wrap" class:image-dropping={isDropping}>
    <input class="file-upload-input" bind:this={fileInput} type="file" on:change={handleFileInput} accept="*" />
