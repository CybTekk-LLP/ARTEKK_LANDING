    ...
    onMount(() => {
      (async function () {
        const cameraKit = await bootstrapCameraKit({
          apiToken:
            "eyJhbGciOiJIUzI1NiIsImtpZCI6IkNhbnZhc1MyU0hNQUNQcm9kIiwidHlwIjoiSldUIn0.eyJhdWQiOiJjYW52YXMtY2FudmFzYXBpIiwiaXNzIjoiY2FudmFzLXMyc3Rva2VuIiwibmJmIjoxNzE3MTQ5Mzg1LCJzdWIiOiIzNDUzYzE4My0wODQ4LTQ2YmEtOTI5ZC04OTM3ODc0MjIwYmV-UFJPRFVDVElPTn4zOTAwY2U3NC05ZTVkLTRiZGQtODMxNS1jNzcyODg5ZjgwMmEifQ.hWLSly6lUfyMgrh9x7nSWA79sAlri7dNWu4-5-mj8ZI",
        });
        ...
        const lens = await cameraKit.lensRepository.loadLens(
          "d0cfa7fd-b1ba-4b32-94b0-ad8bc07ce031",
